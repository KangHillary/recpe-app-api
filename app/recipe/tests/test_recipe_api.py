...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipe_by_tag(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='The green kachumbari recipe from kitui')
        recipe2 = sample_recipe(user=self.user, title='The mashakura recipe from Thika')
